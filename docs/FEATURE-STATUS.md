...
| **Sign-off on the mark** | Nothing — the brand is complete and in use | The mark is a deliberate *redesign* rather than the supplied artwork, which reproduced as the ringed-planet emoji and was illegible below 32px. The reasoning, the rejected alternatives and how to substitute different artwork are in [PACKAGING.md](PACKAGING.md) §6. |
